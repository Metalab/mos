/*
ANGELOL: Taken from Django and fixed up a bit
*/
...
var DateTimeShortcuts = {
    ...
    init: function() {
        ...
        for (i=0; i<inputs.length; i++) {
            var inp = inputs[i];
            if (inp.getAttribute('type') == 'text' && inp.className.match(/vTimeField/) && !inp.className.match(/has_clock/)) {
                DateTimeShortcuts.addClock(inp);
                /* ANGELOL: Make sure the button isn't added more than once */
                inp.addClassName('has_clock');
            }
            else if (inp.getAttribute('type') == 'text' && inp.className.match(/vDateField/) && !inp.className.match(/has_datefield/)) {
                DateTimeShortcuts.addCalendar(inp);
                /* ANGELOL: Make sure the button isn't added more than once */
                inp.addClassName('has_datefield');
            }
        }
    },
